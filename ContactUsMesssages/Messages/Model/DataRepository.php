...
use ContactUsMesssages\Messages\Api\Data\DataSearchResultsInterfaceFactory;
use ContactUsMesssages\Messages\Model\ResourceModel\Data as ResourceData;
use ContactUsMesssages\Messages\Model\ResourceModel\Data\CollectionFactory as DataCollectionFactory;
    ...
    public function delete(DataInterface $data)
    {
        ...
        try {
            ...
            throw new StateException(
                __('Unable to remove messages %1', $id)
            );
        }
        unset($this->instances[$id]);
        return true;
